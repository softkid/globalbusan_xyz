...
### 2.4 결제 시스템
- [ ] Stripe 통합 (카드 결제)
- [ ] Coinbase Commerce API (암호화폐 결제)
- [ ] 다중 통화 지원 (KRW, USD, ETH, BTC)
- [ ] 결제 완료 후 데이터베이스 업데이트
- [ ] 결제 영수증 생성
- [ ] 환불 처리
...
### 우선순위 높은 미완료 항목
1. **결제 시스템 통합** (Stripe, Coinbase Commerce)
2. **블록체인 실제 트랜잭션** (Web3.js 실제 연동)
3. **PDF 다운로드 기능** (보고서, 지분구조)
